...
<div class="row">
    <div class="col-lg-12">
        ...
        <h1 class="page-header breadcrumb">
            <small><i class="fa fa-wrench"></i></small> Edit Product
        </h1>
...
<aside id="admin_sidebar" class="col-md-4">
    ...
    <div class="form-group">
        ...
        <select name="product_category_id" id="" class="form-control">
            <option value="<?php echo $product_category_id; ?>"><?php 
                echo show_product_category_title($product_category_id);

             ?></option>
            <?php show_categories_AP(); ?>
...
<!-- Product Tags -->
   ...
   <!--  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <img width='100' src="../../resources/<?php echo $product_image; ?>" alt="product img">
